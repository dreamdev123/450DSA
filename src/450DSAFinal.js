export default [
	{
		...
		questions: [
			{
				"Topic": "Array",
				"Problem": "What will the output of the below code?",
				"answer": 2, "correct": false, "selected": -1,"option": [
					"1, 2",
					"Syntax error",
					"Run time error",
					"Wrong",
			...
			{
				"Topic": "Array",
				"Problem": "The minimum number of comparisons required to determine if an integer appears more than n/2 times in a sorted array of n integers is",
				"Done": false,
				"answer": 2, "correct": false, "selected": -1,"option": [
			...
			{
				"Topic": "Array",
				"Problem": "An algorithm performs (logN)\
						1/2\
			...
			{
				"Topic": "Array",
				"Problem": "Consider an array consisting of –ve and +ve numbers. What would be the worst case time complexity of an algorithm to segregate the numbers having same sign altogether i.e all +ve on one side and then all -ve on the other ?",
				"Done": false,
				"answer": 2, "correct": false, "selected": -1,"option": [
